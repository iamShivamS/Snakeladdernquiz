...
class MyGame(ShowBase):
    def update(self, task):
        ...
        def question_ask_snakes(self,w1,w2,h):
            ...
            def check1():
                self.set_background_color(0.05, 0.9,0.1,0)
                b1.destroy()
                b2.destroy()
                b3.destroy()
                b4.destroy()
                self.cam.setPos(50 , 40, 280)
                self.textNode_32.setPos(44,104,20.03)
            ...
            def check2():
                ...
                b4.destroy()
                self.cam.setPos(50 , 40, 280)
                self.textNode_31.setPos(44,104,20.03)
        ...
        def question_ask(self,x2,y2,gh):
            ...
            def check1():
                ...
                b4.destroy()
                self.cam.setPos(50 , 40, 280)
                self.textNode_1.setPos(44,104,20.03)
                mu=1
                print(mu)
            def check2():
                self.set_background_color(0.05, 0.9,0.1,0)
                ...
                b4.destroy()
                self.cam.setPos(50 , 40, 280)
                self.textNode_2.setPos(44,104,20.03)
        ...
        if keyMap["left"]:
            ...
            self.textNode_31.setPos(24000,104,20.03)
            self.textNode_32.setPos(24000,104,20.03)
            dice_roll(self,dt)
            for i in range (0,dt):
                if pos2.y in y1:
                        pos2.x -=  10
        ...
        yt=self.hk%4
        if yt==1:
            self.textNodep2.setPos(120,84,20.03)
        else:
            self.textNodep2.setPos(124,840000,20.03)
        if yt==2:
            self.textNodep3.setPos(-24,24,20.03)
        else:
            self.textNodep3.setPos(-14,24000,20.03)
        if yt==3:
            self.textNodep4.setPos(120,24,20.03)
        else:
            self.textNodep4.setPos(114,240000,20.03)
        if yt==0:
            self.textNodep1.setPos(-24,84,20.03)
        else:
            self.textNodep1.setPos(-14,8400000,20.03)
    ...
    def  __init__(self):
        ...
        def welcome_msg():
            self.set_background_color(0.1, 0.4, 0,0.9)
            b.destroy()
            b1.destroy()
            b2.destroy()
            self.cam.setPos(250 , 240, 270)
            # self.cam.setPos(-100 , 45, 280)
            msg = """
            Welcome to Snakes and Ladders Game Quiz 

Rules:
1. Initally all the players are at starting position i.e. 0. Take it 
   in turns to roll the dice. Move forward the number 
   of spaces shown on the dice.
2. If you lands at the bottom of a ladder, you can move up to 
   the top of the ladder only if you answered the pop 
   quesions correctly.
3. If you lands on the head of a snake, you can remain at the .
   same position if you answered the poped up uestion 
   correctly otherwise you will slide down to the bottom of 
   the snake.
4. The first player to get to the FINAL position i.e. 100          .
   will be the winner.
5. Hit the instructed button to roll the dice.                             .

"""
            settings = TextNode('text')
            text.setText(msg)
            textNode = self.render.attachNewNode(text)
            textNode.setScale(4.5)
            textNode.setHpr(0,-90,0)
            textNode.setPos(250,280,20.03)
            self.b8.setPos(0.1,-2,-0.70)
        ...
        self.b8 = DirectButton(text=("Play    "),
                 scale=.08, command=setText)
        self.b8.setPos(400,0,-0.50)
        ...
        self.textNodep1 = self.render.attachNewNode(text)
        self.textNodep1.setScale(4)
        self.textNodep1.setHpr(0,-90,0)
        self.textNodep1.setPos(-14,8400000,20.03)

        text = TextNode('text')
        text.setText("Player 2\nPress : Right Arrrow")
        text.setAlign(TextNode.ACenter)
        self.textNodep2 = self.render.attachNewNode(text)
        self.textNodep2.setScale(4)
        self.textNodep2.setHpr(0,-90,0)
        self.textNodep2.setPos(114,8400000,20.03)

        text = TextNode('text')
        text.setText("Player 3 \nPress : Up Arrrow")
        text.setAlign(TextNode.ACenter)
        self.textNodep3 = self.render.attachNewNode(text)
        self.textNodep3.setScale(4)
        self.textNodep3.setHpr(0,-90,0)
        self.textNodep3.setPos(-14,240000,20.03)

        text = TextNode('text')
        text.setText("Player 4\nPress : Down Arrrow")
        text.setAlign(TextNode.ACenter)
        self.textNodep4 = self.render.attachNewNode(text)
        self.textNodep4.setScale(4)
        self.textNodep4.setHpr(0,-90,0)
        self.textNodep4.setPos(114,240000,20.03)
        ...
        text = TextNode('text')
        text.setText("SORRY !!!! Wrong Answer Cannot Climb Ladder")
        text.setAlign(TextNode.ACenter)
        ...
        self.textNode_2.setPos(24000,104,20.03)
        text = TextNode('text')
        text.setText("CONGRATULATIONS !!!! Correct Answer Climbed the Ladder ")
        text.setAlign(TextNode.ACenter)
        ...
        text = TextNode('text')
        text.setText("SORRY !!!! Wrong Answer Got a Snake Bite")
        text.setAlign(TextNode.ACenter)
        self.textNode_31 = self.render.attachNewNode(text)
        self.textNode_31.setScale(5)
        self.textNode_31.setHpr(0,-90,0)
        self.textNode_31.setPos(24000,104,20.03)
        text = TextNode('text')
        text.setText("CONGRATULATIONS !!!! Correct Answer Avoided Snake Bite ")
        text.setAlign(TextNode.ACenter)
        self.textNode_32 = self.render.attachNewNode(text)
        self.textNode_32.setScale(5)
        self.textNode_32.setHpr(0,-90,0)
        self.textNode_32.setPos(24000,104,20.03)
#1
        text = TextNode('text')
